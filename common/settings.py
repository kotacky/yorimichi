"""
Django settings for common common.
...
# Build paths inside the common like this: os.path.join(BASE_DIR, ...)
...
def is_test():
    """
    Checks, if we're running the server for real or in unit-trying.

    We might need a better implementation of this function.
    """
    if 'trying' in sys.argv or 'testserver' in sys.argv:
        print("Using a trying mongo database")
        return True
    else:
...
# establish connection with default or trying database, depending on the management command, being run
